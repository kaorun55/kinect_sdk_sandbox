================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: tilt_control プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した tilt_control には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには tilt_control アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

tilt_control.vcxproj
...
tilt_control.h
   ...
   Ctilt_controlApp アプリケーション クラスを宣言します。

tilt_control.cpp
   これは、アプリケーション クラス Ctilt_controlApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\tilt_control.ico
   ...
   アイコンはメイン リソース ファイル tilt_control.rc に含まれていま
   す。
...
tilt_controlDlg.h, tilt_controlDlg.cpp - ダイアログ
   これらのファイルは Ctilt_controlDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な tilt_control.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   tilt_control.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
